...
#: Перерыв между академическими часами по Регламенту (не менее 15 минут).
BREAK = dt.timedelta(minutes=15)
#: Шаг сетки часов на портале: 45 + 15 = ровно час.
...
class Block:
    ...
    def label_full(self) -> str:
        """«09:00–10:45 (45 + 15 + 45)» — интервал со структурой."""
...
LEGEND = (
    "Академический час — 45 минут, пара — два часа. Конец указан по сетке "
    "с 15-минутным перерывом внутри пары; если преподаватель ведёт пару без "
    "перерыва, она заканчивается на 15 минут раньше."
)
