...
группам»**: таблицами по корпусам (внутри сначала блок 14:00, потом 16:00, далее по алфавиту):
студент и ВГ · время · куда (аудитория, институт) и преподаватель и отдельно — у кого занятие отменено. Раздел только про
